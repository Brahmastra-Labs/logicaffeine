...
| [Execution & performance](execution-and-performance.md) | The interpreter, bytecode VM, copy-and-patch JIT, AOT codegen, and the direct WASM backend |
...
---
[Root README](../README.md) · [Changelog](../CHANGELOG.md)
