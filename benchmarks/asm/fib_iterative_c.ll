; ModuleID = '/Users/tristen/logicaffeine/logicaffeine/benchmarks/programs/fib_iterative/main.c'
source_filename = "/Users/tristen/logicaffeine/logicaffeine/benchmarks/programs/fib_iterative/main.c"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128"
target triple = "arm64-apple-macosx15.0.0"

@__stderrp = external local_unnamed_addr global ptr, align 8
@.str = private unnamed_addr constant [26 x i8] c"Usage: fib_iterative <n>\0A\00", align 1
...
4:                                                ; preds = %2
  ...
  %6 = tail call i64 @fwrite(ptr nonnull @.str, i64 25, i64 1, ptr %5)
  br label %23
...
12:                                               ; preds = %15, %7
  %13 = phi i64 [ 0, %7 ], [ %17, %15 ]
  %14 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i64 noundef %13)
  br label %23

15:                                               ; preds = %7, %15
  %16 = phi i64 [ %21, %15 ], [ 0, %7 ]
  %17 = phi i64 [ %20, %15 ], [ 1, %7 ]
  %18 = phi i64 [ %17, %15 ], [ 0, %7 ]
  %19 = add nsw i64 %17, %18
  %20 = srem i64 %19, 1000000007
  %21 = add nuw nsw i64 %16, 1
  %22 = icmp eq i64 %21, %10
  br i1 %22, label %12, label %15, !llvm.loop !10
