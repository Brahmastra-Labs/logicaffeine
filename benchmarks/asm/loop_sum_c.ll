; ModuleID = '/Users/tristen/logicaffeine/logicaffeine/benchmarks/programs/loop_sum/main.c'
source_filename = "/Users/tristen/logicaffeine/logicaffeine/benchmarks/programs/loop_sum/main.c"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128"
target triple = "arm64-apple-macosx15.0.0"

@__stderrp = external local_unnamed_addr global ptr, align 8
@.str = private unnamed_addr constant [21 x i8] c"Usage: loop_sum <n>\0A\00", align 1
...
4:                                                ; preds = %2
  ...
  %6 = tail call i64 @fwrite(ptr nonnull @.str, i64 20, i64 1, ptr %5)
  br label %22
...
15:                                               ; preds = %7, %15
  ...
  br i1 %21, label %12, label %15, !llvm.loop !10
