...
use crate::kernel::{Context, KernelError, KernelResult, Term};

use super::{DerivationTree, InferenceRule, ProofExpr, ProofTerm};
...
// =============================================================================
// CERTIFICATION CONTEXT - Wraps kernel context with proof state
// =============================================================================

/// Context for certification, wrapping the kernel context.
...
///
/// The resulting term, when type-checked, should have the type
/// corresponding to the tree's conclusion.
