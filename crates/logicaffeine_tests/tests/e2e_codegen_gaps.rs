//! E2E Codegen Tests: Feature Coverage Gaps
//!
//! Tests for language features with zero Rust codegen coverage:
//! floats, modulo, options, nothing, collection type combos,
//! struct/enum patterns, advanced control flow, function patterns,
//! escape blocks, string operations.

#[cfg(not(target_arch = "wasm32"))]
mod common;

#[cfg(not(target_arch = "wasm32"))]
use common::{assert_exact_output, run_logos};
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_float_literal() {
    assert_exact_output("## Main\nShow 3.14.", "3.14");
}

#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_float_addition() {
    assert_exact_output("## Main\nShow 1.5 + 2.5.", "4");
}

#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_float_subtraction() {
    assert_exact_output("## Main\nShow 10.5 - 3.2.", "7.3");
}

#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_float_multiplication() {
    assert_exact_output("## Main\nShow 2.5 * 4.0.", "10");
}

#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_float_division() {
    assert_exact_output("## Main\nShow 7.5 / 2.5.", "3");
}

#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_float_comparison() {
    assert_exact_output(
        r#"## Main
Let x be 3.14.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_float_in_function() {
    assert_exact_output(
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_float_negative() {
    assert_exact_output("## Main\nShow 0.0 - 3.14.", "-3.14");
}

#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_float_equality() {
    assert_exact_output(
        r#"## Main
Let a be 2.5.
Let b be 2.5.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_float_typed_variable() {
    assert_exact_output(
        r#"## Main
Let x be 2.718.
Show x.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_modulo_basic() {
    assert_exact_output("## Main\nShow 10 % 3.", "1");
}

#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_modulo_even_check() {
    assert_exact_output(
        r#"## Main
Let x be 4.
If x % 2 equals 0:
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_option_some_in_function() {
    assert_exact_output(
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_option_none_in_function() {
    assert_exact_output(
        r#"## To find (n: Int) -> Option of Int:
    If n is greater than 0:
        Return some n.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_option_inspect_some() {
    assert_exact_output(
        r#"## A Maybe is one of:
    A Nothing.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_option_inspect_none() {
    assert_exact_output(
        r#"## A Maybe is one of:
    A Nothing.
    A Just with value Int.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_nothing_literal() {
    assert_exact_output(
        r#"## Main
Let x be nothing.
Show "after".
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_map_text_to_text() {
    assert_exact_output(
        r#"## Main
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_map_text_to_bool() {
    assert_exact_output(
        r#"## Main
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_map_int_to_text() {
    assert_exact_output(
        r#"## Main
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_empty_map_length() {
    assert_exact_output(
        r#"## Main
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_empty_set_length() {
    assert_exact_output(
        r#"## Main
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_map_length_after_mutations() {
    assert_exact_output(
        r#"## Main
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_set_text_iterate() {
    assert_exact_output(
        r#"## Main
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_struct_mixed_fields() {
    assert_exact_output(
        r#"## A Person has:
    A name: Text.
    An age: Int.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_enum_three_variants() {
    assert_exact_output(
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_enum_mixed_unit_payload() {
    assert_exact_output(
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_enum_mixed_failure_branch() {
    assert_exact_output(
        r#"## A Result is one of:
    A Success with value Int.
    A Failure.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_struct_copy_independence() {
    assert_exact_output(
        r#"## A Point has:
    An x: Int.
    A y: Int.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_struct_deep_field() {
    assert_exact_output(
        r#"## A Inner has:
    A value: Int.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_if_no_otherwise() {
    assert_exact_output(
        r#"## Main
Let x be 3.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_triple_nested_loop() {
    assert_exact_output(
        r#"## Main
Let count be 0.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_return_from_while() {
    assert_exact_output(
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_while_compound_or() {
    assert_exact_output(
        r#"## Main
Let x be 0.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_inspect_inside_if() {
    assert_exact_output(
        r#"## A Color is one of:
    A Red.
    A Green.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_two_sequential_while() {
    assert_exact_output(
        r#"## Main
Let a be 0.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_range_variable_bounds() {
    assert_exact_output(
        r#"## Main
Let lo be 3.
Let hi be 7.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_function_returns_struct() {
    assert_exact_output(
        r#"## A Point has:
    An x: Int.
    A y: Int.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_three_function_chain() {
    assert_exact_output(
        r#"## To inc (x: Int) -> Int:
    Return x + 1.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_function_builds_map() {
    assert_exact_output(
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_side_effect_function() {
    assert_exact_output(
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_function_four_params() {
    assert_exact_output(
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_mutual_recursion() {
    assert_exact_output(
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_function_returns_option() {
    assert_exact_output(
...
"#;
    ...
    assert!(
        result.success,
        "Escape block should compile.\nGenerated Rust:\n{}\n\nstderr: {}",
        result.rust_code,
        result.stderr
    );
    assert_eq!(result.stdout.trim(), "from rust", "Got: {}", result.stdout);
}

#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_escape_reads_variable() {
    let source = r#"## Main
Let x be 42.
Escape to Rust:
    println!("{}", x);
"#;
    ...
    assert!(
        result.success,
        "Escape reading var should compile.\nGenerated Rust:\n{}\n\nstderr: {}",
        result.rust_code,
        result.stderr
    );
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_escape_writes_output() {
    let source = r#"## Main
Let x be 5.
Escape to Rust:
    let y = x + 10;
...
"#;
    ...
    assert!(
        result.success,
        "Escape writing derived value should compile.\nGenerated Rust:\n{}\n\nstderr: {}",
        result.rust_code,
        result.stderr
    );
...
"#;
    ...
    assert!(
        result.success,
        "Empty escape block should compile.\nGenerated Rust:\n{}\n\nstderr: {}",
        result.rust_code,
        result.stderr
    );
    assert_eq!(result.stdout.trim(), "after", "Got: {}", result.stdout);
}
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_string_not_equals() {
    assert_exact_output(
        r#"## Main
Let a be "hello".
Let b be "world".
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_string_contains() {
    assert_exact_output(
        r#"## Main
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_string_empty_length() {
    assert_exact_output(
        r#"## Main
Let s be "".
Show length of s.
...
#[cfg(not(target_arch = "wasm32"))]
#[test]
fn e2e_codegen_string_combined_with() {
    assert_exact_output(
        r#"## Main
Let a be "foo".
Let b be "bar".
