use logicaffeine_language::{compile, compile_simple, compile_all_scopes, compile_forest};
...
fn lacks_scope_ambiguity() {
    ...
    let results = compile_forest("Every user who lacks a key enters the room.");
...
fn unaccusative_intransitive_theme_subject() {
    ...
    let output = compile("The alarm triggers.");
...
fn unaccusative_transitive_agent_subject() {
    ...
    let output = compile("John triggers the alarm.");
...
fn unaccusative_break_intransitive() {
    let output = compile("The window breaks.");
...
fn unaccusative_melt_intransitive() {
    let output = compile("The ice melts.");
...
fn may_polysemy_permission_vs_possibility() {
    ...
    let results = compile_forest("Students may leave.");
...
fn may_permission_narrow_scope() {
    ...
    let output = compile("Students may leave.").unwrap();
...
fn can_polysemy_ability_vs_permission() {
    ...
    let results = compile_forest("Students can leave.");
...
fn could_polysemy_narrow_vs_wide_scope() {
    ...
    let results = compile_forest("Some students could pass.");
