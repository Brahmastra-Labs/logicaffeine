...
fn e2e_test_diagnostic_module_compiles() {
    use logicaffeine_compile::sourcemap::SourceMap;
...
fn e2e_test_json_parsing_extracts_e0382() {
    use logicaffeine_compile::diagnostic::{parse_rustc_json, get_error_code};
...
fn e2e_test_translator_produces_friendly_message_for_e0382() {
    use logicaffeine_compile::diagnostic::{parse_rustc_json, DiagnosticBridge};
    use logicaffeine_compile::sourcemap::SourceMap;
