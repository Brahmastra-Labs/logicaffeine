...
fn test_pncounter_delta_increment() {
    use logicaffeine_data::crdt::{DeltaCrdt, PNCounter};
...
fn test_pncounter_delta_decrement() {
    use logicaffeine_data::crdt::{DeltaCrdt, PNCounter, VClock};
...
fn test_mvregister_delta_set() {
    use logicaffeine_data::crdt::{DeltaCrdt, MVRegister};
...
fn test_mvregister_delta_preserves_conflicts() {
    use logicaffeine_data::crdt::{DeltaCrdt, MVRegister, VClock};
...
fn test_orset_delta_add() {
    use logicaffeine_data::crdt::{DeltaCrdt, ORSet};
...
fn test_orset_delta_remove() {
    use logicaffeine_data::crdt::{DeltaCrdt, Merge, ORSet, VClock};
...
fn test_rga_delta_append() {
    use logicaffeine_data::crdt::{DeltaCrdt, RGA};
...
fn test_rga_delta_remove() {
    use logicaffeine_data::crdt::{DeltaCrdt, RGA, VClock};
...
fn test_yata_delta_append() {
    use logicaffeine_data::crdt::{DeltaCrdt, YATA};
...
fn test_ormap_delta_insert() {
    use logicaffeine_data::crdt::{DeltaCrdt, ORMap, PNCounter};
...
fn test_version_tracks_all_replicas() {
    use logicaffeine_data::crdt::{DeltaCrdt, Merge, PNCounter};
