...
//!
//! This module converts the internal AST representation to human-readable
//! logical formulas in various output formats.
//!
//! ## Output Formats
//!
...
//! ```
//!
//! This representation enables reasoning about event modification,
...
/// Extracts top-level conjuncts from a discourse (sentences combined with AND).
