...
fn kripke_possibility_basic() {
    ...
    let output = logos::compile_kripke("John can fly.").unwrap();
...
fn kripke_necessity_basic() {
    ...
    let output = logos::compile_kripke("John must study.").unwrap();
...
fn kripke_deontic_accessibility() {
    ...
    let output = logos::compile_kripke("John should study.").unwrap();
...
fn kripke_alethic_can() {
    ...
    let output = logos::compile_kripke("Birds can fly.").unwrap();
...
fn kripke_non_modal_at_actual_world() {
    ...
    let output = logos::compile_kripke("John runs.").unwrap();
...
fn kripke_nested_modals() {
    ...
    let output = logos::compile_kripke("John might be able to fly.").unwrap();
...
fn kripke_quantified_subject_with_modal() {
    ...
    let output = logos::compile_kripke("Every student can pass.").unwrap();
...
fn kripke_existential_with_necessity() {
    ...
    let output = logos::compile_kripke("Some student must pass.").unwrap();
...
fn kripke_deep_differs_from_surface() {
    ...
    let surface = logos::compile("John can fly.").unwrap();
    let deep = logos::compile_kripke("John can fly.").unwrap();
