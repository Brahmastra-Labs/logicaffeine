...
use logos::proof::{BackwardChainer, InferenceRule, ProofExpr, ProofTerm};
...
#[test]
#[ignore] // TODO: Implement prove_with_goal API
fn test_oracle_respects_context_assumptions() {
    ...
    // This test requires prove_with_goal() which takes a ProofGoal with context.
    todo!("Implement prove_with_goal API to test context assumptions");
}
