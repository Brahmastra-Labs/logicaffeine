...
Show "done"."#;
    ...
    let rust = compile_to_rust(source).expect("Should compile");
    assert!(
        rust.contains("logos_core::crdt::ORSet<String, logos_core::crdt::AddWins>"),
...
Show "done"."#;
    ...
    let rust = compile_to_rust(source).expect("Should compile");
    assert!(
        rust.contains("logos_core::crdt::ORSet<String, logos_core::crdt::RemoveWins>"),
...
Show "done"."#;
    ...
    let rust = compile_to_rust(source).expect("Should compile");
    assert!(
        rust.contains("logos_core::crdt::YATA<String>"),
...
Show "done"."#;
    ...
    let rust = compile_to_rust(source).expect("Should compile");
    assert!(
        rust.contains("logos_core::crdt::ORMap<String, i64>"),
...
Show "done"."#;
    ...
    let rust = compile_to_rust(source).expect("Should compile");
    assert!(
        rust.contains("logos_core::crdt::ORMap<String, bool>"),
...
Show "done"."#;
    ...
    assert!(rust.contains("logos_core::crdt::PNCounter"), "Should have PNCounter for Tally");
    assert!(rust.contains("logos_core::crdt::ORSet<String, logos_core::crdt::AddWins>"), "Should have AddWins ORSet");
    assert!(rust.contains("logos_core::crdt::ORSet<String, logos_core::crdt::RemoveWins>"), "Should have RemoveWins ORSet");
    assert!(rust.contains("logos_core::crdt::RGA<String>"), "Should have RGA");
    assert!(rust.contains("logos_core::crdt::YATA<String>"), "Should have YATA");
    assert!(rust.contains("logos_core::crdt::ORMap<String, i64>"), "Should have ORMap");
    assert!(rust.contains("logos_core::crdt::MVRegister<String>"), "Should have MVRegister");
}
