...
/// Test that native functions generate logos_core calls.
#[test]
...
"#;
    ...
    // Should delegate to logos_core
    assert!(rust.contains("logos_core::file::read"), "Should call logos_core::file::read");
}
...
"#;
    ...
    assert!(rust.contains("logos_core::time::now"), "Should call logos_core::time::now");
}
...
"#;
    ...
    assert!(rust.contains("logos_core::random::randomInt"), "Should call logos_core::random::randomInt");
}
...
"#;
    ...
    assert!(rust.contains("logos_core::env::args"), "Should call logos_core::env::args");
}
