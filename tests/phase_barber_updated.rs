...
fn test_simple_man_premise() {
    ...
    let result = logos::compile_theorem_for_ui(r#"## Theorem: Simple_Man
...
fn test_definite_man_premise() {
    ...
    let result = logos::compile_theorem_for_ui(r#"## Theorem: Definite_Man
Given: The barber is a man.
...
"#);
    ...
    use logos::{BackwardChainer, ProofExpr};
