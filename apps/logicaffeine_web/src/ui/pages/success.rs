...
//!
//! Post-checkout page that retrieves the license key from Stripe's checkout
//! session and saves it to the browser's localStorage. Features:
//!
...
//! # Route
//!
//! Accessed via [`Route::Success`] with
//! a `session_id` query parameter from Stripe.
