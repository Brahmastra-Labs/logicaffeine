...
//!
//! Provides a searchable grid of mathematical symbols organized by category
//! (Greek, Logic, Sets, Relations, Operators). Clicking inserts the LaTeX code.
//!
//! # Props
//!
//! - `on_insert` - Callback with the LaTeX command to insert
//!
//! # Categories
//!
//! - **Greek**: α, β, γ... and uppercase variants
//! - **Logic**: ∀, ∃, ∧, ∨, →, ↔, ⊢, ⊨, □, ◇
//! - **Sets**: ∈, ⊆, ∪, ∩, ∅, ℕ, ℤ, ℚ, ℝ, ℂ
//! - **Relations**: ≠, ≤, ≥, ≈, ≡, ∼
//! - **Operators**: ×, ÷, ±, ·, ∘, √, ∞, ∂, ∇, ∫, Σ
